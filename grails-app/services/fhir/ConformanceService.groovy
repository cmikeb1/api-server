...
class ConformanceService {
  ...
  def generateConformance(){
    ...
    if (oauth.enabled) {
        ...
        registerUriExtension.setUrl( "http://fhir-registry.smarthealthit.org/Profile/oauth-uris#register")
        ...
        authorizeUriExtension.setUrl("http://fhir-registry.smarthealthit.org/Profile/oauth-uris#authorize")
        ...
        tokenUriExtension.setUrl("http://fhir-registry.smarthealthit.org/Profile/oauth-uris#token")
